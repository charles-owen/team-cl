        ...
        <template :key="team.id" v-for="team in teams">
          <tr class="cl-internal">
            <th class="right"><span v-if="team.name !== null">
              <a @click.prevent="editer(team)"><img :src="root + '/vendor/cl/site/img/pencil16.png'" alt="Edit"
                                                    title="Edit"></a>
              <a @click.prevent="deleter(team)"><img :src="root + '/vendor/cl/site/img/x.png'" alt="Delete"
                                                     title="Delete"></a></span>
              ...
              <a @click.prevent="toggle(team)"><img
                  :src="$site.root + '/vendor/cl/site/img/' + (open[team.id] === true ? 'minus.png' : 'plus.png')"></a>
            </th>
            ...
            <tr v-for="member in team.members">
              <td class="right">
                <cl-menu>
                  <a><img :src="root + '/vendor/cl/site/img/menubars.png'"></a>
                  <ul>
                    <li v-for="team1 in teams"><a
                        @click.prevent="move(member, team1)">{{ team1.name !== null ? team1.name : 'Unassigned' }}<img
                        v-if="team === team1" :src="root + '/vendor/cl/site/img/check16.png'"></a></li>
                  </ul>
                </cl-menu>
              </td>
